...
# ---------------------------------------------------------
# Compiled Python file from GUI  file made with Qt Designer
# ---------------------------------------------------------
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        sizePolicy1.setHeightForWidth(self.frame_center.sizePolicy().hasHeightForWidth())
        ...
        self.functionString = QLineEdit(self.frame_content_wid_1)
        self.functionString.setObjectName(u"functionString")
        self.functionString.setMinimumSize(QSize(0, 30))
        self.functionString.setStyleSheet(u"QLineEdit {\n"
                                          "	background-color: rgb(27, 29, 35);\n"
                                          "	border-radius: 5px;\n"
                                          "	border: 2px solid rgb(27, 29, 35);\n"
                                          "	padding-left: 10px;\n"
        ...
        self.gridLayout.addWidget(self.functionString, 0, 0, 1, 1)
        ...
        self.plotBtn = QPushButton(self.frame_content_wid_1)
        self.plotBtn.setObjectName(u"plotBtn")
        self.plotBtn.setMinimumSize(QSize(150, 30))
        font2 = QFont()
        font2.setFamily(u"Segoe UI")
        font2.setPointSize(9)
        self.plotBtn.setFont(font2)
        self.plotBtn.setStyleSheet(u"QPushButton {\n"
        ...
        self.gridLayout.addWidget(self.plotBtn, 0, 1, 1, 1)
        ...
        self.verticalLayout_14 = QVBoxLayout(self.frame_title_wid_2)
        self.verticalLayout_14.setObjectName(u"verticalLayout_14")
        self.labelBoxBlenderInstalation_5 = QLabel(self.frame_title_wid_2)
        ...
        self.verticalLayout_14.addWidget(self.labelBoxBlenderInstalation_5)

        self.verticalLayout_11.addWidget(self.frame_title_wid_2)

        self.gridLayout_2 = QGridLayout()
        self.gridLayout_2.setObjectName(u"gridLayout_2")
        self.minLimitNumber = QSpinBox(self.frame_2)
        self.minLimitNumber.setObjectName(u"minLimitNumber")
        sizePolicy5 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.MinimumExpanding)
        sizePolicy5.setHorizontalStretch(0)
        sizePolicy5.setVerticalStretch(0)
        sizePolicy5.setHeightForWidth(self.minLimitNumber.sizePolicy().hasHeightForWidth())
        self.minLimitNumber.setSizePolicy(sizePolicy5)
        self.minLimitNumber.setMaximumSize(QSize(16777215, 40))
        self.minLimitNumber.setStyleSheet(u"QSpinBox {\n"
                                          "	background-color: rgb(27, 29, 35);\n"
                                          "	border-radius: 5px;\n"
                                          "	border: 2px solid rgb(27, 29, 35);\n"
                                          "	padding-left: 10px;\n"
                                          ...
                                          "	border: 2px solid rgb(91, 101, 124);\n"
                                          "}")
        self.minLimitNumber.setWrapping(False)
        self.minLimitNumber.setFrame(True)
        self.minLimitNumber.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.minLimitNumber.setKeyboardTracking(True)
        self.minLimitNumber.setProperty("showGroupSeparator", False)
        self.minLimitNumber.setMinimum(-1000000)
        self.minLimitNumber.setMaximum(1000000)

        self.gridLayout_2.addWidget(self.minLimitNumber, 1, 1, 1, 1)

        self.horizontalSpacer_5 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_2.addItem(self.horizontalSpacer_5, 1, 2, 1, 1)

        self.labelBoxBlenderInstalation_4 = QLabel(self.frame_2)
        ...
        font3.setBold(True)
        font3.setWeight(75)
        self.labelBoxBlenderInstalation_4.setFont(font3)
        self.labelBoxBlenderInstalation_4.setStyleSheet(u"")

        self.gridLayout_2.addWidget(self.labelBoxBlenderInstalation_4, 2, 1, 1, 1)

        self.labelBoxBlenderInstalation_3 = QLabel(self.frame_2)
        self.labelBoxBlenderInstalation_3.setObjectName(u"labelBoxBlenderInstalation_3")
        self.labelBoxBlenderInstalation_3.setFont(font3)
        self.labelBoxBlenderInstalation_3.setStyleSheet(u"")

        self.gridLayout_2.addWidget(self.labelBoxBlenderInstalation_3, 0, 1, 1, 1)

        self.horizontalSpacer = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_2.addItem(self.horizontalSpacer, 1, 0, 1, 1)

        self.maxLimitNumber = QSpinBox(self.frame_2)
        self.maxLimitNumber.setObjectName(u"maxLimitNumber")
        sizePolicy6 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Ignored)
        sizePolicy6.setHorizontalStretch(0)
        sizePolicy6.setVerticalStretch(0)
        sizePolicy6.setHeightForWidth(self.maxLimitNumber.sizePolicy().hasHeightForWidth())
        self.maxLimitNumber.setSizePolicy(sizePolicy6)
        self.maxLimitNumber.setMaximumSize(QSize(16777215, 40))
        self.maxLimitNumber.setStyleSheet(u"QSpinBox {\n"
                                          "	background-color: rgb(27, 29, 35);\n"
                                          "	border-radius: 5px;\n"
                                          "	border: 2px solid rgb(27, 29, 35);\n"
                                          "	padding-left: 10px;\n"
                                          ...
                                          "	border: 2px solid rgb(91, 101, 124);\n"
                                          "}")
        self.maxLimitNumber.setWrapping(False)
        self.maxLimitNumber.setFrame(True)
        self.maxLimitNumber.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.maxLimitNumber.setKeyboardTracking(True)
        self.maxLimitNumber.setProperty("showGroupSeparator", False)
        self.maxLimitNumber.setMinimum(-1000000)
        self.maxLimitNumber.setMaximum(1000000)

        self.gridLayout_2.addWidget(self.maxLimitNumber, 3, 1, 1, 1)
        ...
        self.gridLayout_2.setRowStretch(3, 30)
        self.gridLayout_2.setColumnStretch(0, 35)
        self.gridLayout_2.setColumnStretch(1, 30)
        self.gridLayout_2.setColumnStretch(2, 35)
        ...
        self.frame_3.setStyleSheet(u"background-color:#272c36;")
        ...
        self.horizontalLayout_12.addLayout(self.plotLayout)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelBoxBlenderInstalation.setText(
            QCoreApplication.translate("MainWindow", u"Write Your Function Here", None))
        self.functionString.setPlaceholderText(
            QCoreApplication.translate("MainWindow", u"Function Statement e.g. 5*x^3 + 2*x.", None))
        self.labelVersion_3.setText(
            QCoreApplication.translate("MainWindow", u"These are the supported operators: + - / * ^.", None))
        self.plotBtn.setText(QCoreApplication.translate("MainWindow", u"Plot", None))
        self.labelBoxBlenderInstalation_5.setText(QCoreApplication.translate("MainWindow", u"Plot Controls", None))
        self.labelBoxBlenderInstalation_4.setText(QCoreApplication.translate("MainWindow", u"Maximum X Limit", None))
        self.labelBoxBlenderInstalation_3.setText(QCoreApplication.translate("MainWindow", u"Minimum X Limit", None))
